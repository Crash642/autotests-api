...
from clients.exercises.exercises_schema import CreateExerciseResponseSchema, CreateExerciseRequestSchema, ExercisesSchema, GetExerciseResponseSchema
...
def assert_exercise(actual: ExercisesSchema, expected: ExercisesSchema):
    ...
    :param actual: Данные упражнения из ответа API.
...
def assert_get_exercise_response(
    ...
    :param get_exercise_response: Ответ API на получение упражнения.
    :param create_exercise_response: Ответ API на создание упражнения.
    :raises AssertionError: Если хотя бы одно поле не совпадает.
    """
